; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26730.0 
	...
	TITLE	D:\BAC_INFORMATIQUE\Intelligence Artificielle\RavenProject\Common\fuzzy\FuzzyOperators.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_1LC@GGGINJLF@?$AAd?$AA?3?$AA?2?$AAb?$AAa?$AAc?$AA_?$AAi?$AAn?$AAf?$AAo?$AAr?$AAm?$AAa?$AAt@ ; `string'
...
??_C@_1FC@EJGEACIH@?$AA0?$AA?5?$AA?$CG?$AA?$CG?$AA?5?$AA?$CC?$AA?$DM?$AAF?$AAz?$AAO?$AAR?$AA?3?$AA?3?$AAC?$AAl@ DB '0'
	...
	DB	00H, 00H, 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_1LC@GGGINJLF@?$AAd?$AA?3?$AA?2?$AAb?$AAa?$AAc?$AA_?$AAi?$AAn?$AAf?$AAo?$AAr?$AAm?$AAa?$AAt@
CONST	SEGMENT
??_C@_1LC@GGGINJLF@?$AAd?$AA?3?$AA?2?$AAb?$AAa?$AAc?$AA_?$AAi?$AAn?$AAf?$AAo?$AAr?$AAm?$AAa?$AAt@ DB 'd'
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\bac_informatique\intelligence artificielle\ravenproject\common\fuzzy\fuzzyoperators.h
...
; 86   : 	void ORwithDOM(double val) { assert(0 && "<FzOR::ORwithDOM>: invalid context"); }
	...
	push	86					; 00000056H
	push	OFFSET ??_C@_1LC@GGGINJLF@?$AAd?$AA?3?$AA?2?$AAb?$AAa?$AAc?$AA_?$AAi?$AAn?$AAf?$AAo?$AAr?$AAm?$AAa?$AAt@
...
; 85   : 	void ClearDOM() { assert(0 && "<FzOR::ClearDOM>: invalid context"); }
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\bac_informatique\intelligence artificielle\ravenproject\common\fuzzy\fuzzyoperators.cpp
_TEXT	SEGMENT
tv132 = -108						; size = 4
tv165 = -104						; size = 8
tv91 = -96						; size = 4
...
; 143  : 	double largest = MinFloat;

	movsd	xmm0, QWORD PTR __real@3810000000000000
	movsd	QWORD PTR _largest$[ebp], xmm0

; 144  : 
; 145  : 	std::vector<FuzzyTerm*>::const_iterator curTerm;

	lea	ecx, DWORD PTR _curTerm$[ebp]
	call	??0?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@PAVFuzzyTerm@@@std@@@std@@@std@@QAE@XZ ; std::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<FuzzyTerm *> > >::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<FuzzyTerm *> > >
	mov	DWORD PTR __$EHRec$[ebp+8], 0

; 146  : 	for (curTerm = m_Terms.begin(); curTerm != m_Terms.end(); ++curTerm)
...
; 80   : 	FuzzyTerm* Clone()const { return new FzOR(*this); }
...
; 122  : 	m_Terms.push_back(op1.Clone());
...
; 123  : 	m_Terms.push_back(op2.Clone());
...
; 124  : 	m_Terms.push_back(op3.Clone());
...
; 125  : 	m_Terms.push_back(op4.Clone());
...
; 114  : 	m_Terms.push_back(op1.Clone());
...
; 115  : 	m_Terms.push_back(op2.Clone());
...
; 116  : 	m_Terms.push_back(op3.Clone());
...
; 107  : 	m_Terms.push_back(op1.Clone());
...
; 108  : 	m_Terms.push_back(op2.Clone());
...
; 97   : 	std::vector<FuzzyTerm*>::const_iterator curTerm;

	lea	ecx, DWORD PTR _curTerm$[ebp]
	call	??0?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@PAVFuzzyTerm@@@std@@@std@@@std@@QAE@XZ ; std::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<FuzzyTerm *> > >::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<FuzzyTerm *> > >
	mov	BYTE PTR __$EHRec$[ebp+8], 2

; 98   : 	for (curTerm = fa.m_Terms.begin(); curTerm != fa.m_Terms.end(); ++curTerm)
...
; 99   : 	{
; 100  : 		m_Terms.push_back((*curTerm)->Clone());
...
; 130  : 	std::vector<FuzzyTerm*>::iterator curTerm;
...
; 131  : 	for (curTerm = m_Terms.begin(); curTerm != m_Terms.end(); ++curTerm)
...
; 73   : 	std::vector<FuzzyTerm*>::iterator curTerm;

	lea	ecx, DWORD PTR _curTerm$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@PAVFuzzyTerm@@@std@@@std@@@std@@QAE@XZ ; std::_Vector_iterator<std::_Vector_val<std::_Simple_types<FuzzyTerm *> > >::_Vector_iterator<std::_Vector_val<std::_Simple_types<FuzzyTerm *> > >
	mov	DWORD PTR __$EHRec$[ebp+8], 0

; 74   : 	for (curTerm = m_Terms.begin(); curTerm != m_Terms.end(); ++curTerm)
...
; 83   : 	std::vector<FuzzyTerm*>::iterator curTerm;

	lea	ecx, DWORD PTR _curTerm$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@PAVFuzzyTerm@@@std@@@std@@@std@@QAE@XZ ; std::_Vector_iterator<std::_Vector_val<std::_Simple_types<FuzzyTerm *> > >::_Vector_iterator<std::_Vector_val<std::_Simple_types<FuzzyTerm *> > >
	mov	DWORD PTR __$EHRec$[ebp+8], 0

; 84   : 	for (curTerm = m_Terms.begin(); curTerm != m_Terms.end(); ++curTerm)
...
; 56   : 	double smallest = MaxDouble;

	movsd	xmm0, QWORD PTR __real@7fefffffffffffff
	movsd	QWORD PTR _smallest$[ebp], xmm0

; 57   : 
; 58   : 	std::vector<FuzzyTerm*>::const_iterator curTerm;

	lea	ecx, DWORD PTR _curTerm$[ebp]
	call	??0?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@PAVFuzzyTerm@@@std@@@std@@@std@@QAE@XZ ; std::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<FuzzyTerm *> > >::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<FuzzyTerm *> > >
	mov	DWORD PTR __$EHRec$[ebp+8], 0

; 59   : 	for (curTerm = m_Terms.begin(); curTerm != m_Terms.end(); ++curTerm)
...
; 43   : 	std::vector<FuzzyTerm*>::iterator curTerm;

	lea	ecx, DWORD PTR _curTerm$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@PAVFuzzyTerm@@@std@@@std@@@std@@QAE@XZ ; std::_Vector_iterator<std::_Vector_val<std::_Simple_types<FuzzyTerm *> > >::_Vector_iterator<std::_Vector_val<std::_Simple_types<FuzzyTerm *> > >

; 44   : 	for (curTerm = m_Terms.begin(); curTerm != m_Terms.end(); ++curTerm)
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\bac_informatique\intelligence artificielle\ravenproject\common\fuzzy\fuzzyterm.h
