; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26730.0 
	...
	TITLE	D:\Documents\CANADA\COURS\IA\Travaux\RavenProject\Common\misc\Cgdi.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
text$yd	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\documents\canada\cours\ia\travaux\ravenproject\common\misc\cgdi.cpp
_TEXT	SEGMENT
__$EHRec$ = -12						; size = 12
...
; 66   : 
; 67   : 	DeleteObject(m_DarkGreenPen);
...
; 68   : 
; 69   : 	DeleteObject(m_LightBluePen);
...
; 70   : 	DeleteObject(m_LightGreyPen);
...
; 71   : 	DeleteObject(m_LightPinkPen);
...
; 72   : 
; 73   : 	DeleteObject(m_ThickBlackPen);
...
; 74   : 	DeleteObject(m_ThickWhitePen);
...
; 76   : 	DeleteObject(m_ThickGreenPen);
...
; 77   : 	DeleteObject(m_ThickBluePen);
...
; 85   : 	DeleteObject(m_LightBlueBrush);
...
; 87   : 	DeleteObject(m_DarkGreenBrush);
...
; 15   : 	m_BlackPen = CreatePen(PS_SOLID, 1, colors[black]);
...
; 16   : 	m_WhitePen = CreatePen(PS_SOLID, 1, colors[white]);
...
; 17   : 	m_RedPen = CreatePen(PS_SOLID, 1, colors[red]);
...
; 18   : 	m_GreenPen = CreatePen(PS_SOLID, 1, colors[green]);
...
; 19   : 	m_BluePen = CreatePen(PS_SOLID, 1, colors[blue]);
...
; 20   : 	m_GreyPen = CreatePen(PS_SOLID, 1, colors[grey]);
...
; 21   : 	m_PinkPen = CreatePen(PS_SOLID, 1, colors[pink]);
...
; 22   : 	m_YellowPen = CreatePen(PS_SOLID, 1, colors[yellow]);
...
; 23   : 	m_OrangePen = CreatePen(PS_SOLID, 1, colors[orange]);
...
; 24   : 	m_PurplePen = CreatePen(PS_SOLID, 1, colors[purple]);
...
; 25   : 	m_BrownPen = CreatePen(PS_SOLID, 1, colors[brown]);
...
; 26   : 
; 27   : 	m_DarkGreenPen = CreatePen(PS_SOLID, 1, colors[dark_green]);
...
; 28   : 
; 29   : 	m_LightBluePen = CreatePen(PS_SOLID, 1, colors[light_blue]);
...
; 30   : 	m_LightGreyPen = CreatePen(PS_SOLID, 1, colors[light_grey]);
...
; 31   : 	m_LightPinkPen = CreatePen(PS_SOLID, 1, colors[light_pink]);
...
; 32   : 
; 33   : 	m_ThickBlackPen = CreatePen(PS_SOLID, 2, colors[black]);
...
; 34   : 	m_ThickWhitePen = CreatePen(PS_SOLID, 2, colors[white]);
...
; 35   : 	m_ThickRedPen = CreatePen(PS_SOLID, 2, colors[red]);
...
; 36   : 	m_ThickGreenPen = CreatePen(PS_SOLID, 2, colors[green]);
...
; 37   : 	m_ThickBluePen = CreatePen(PS_SOLID, 2, colors[blue]);
...
; 38   : 
; 39   : 	m_GreenBrush = CreateSolidBrush(colors[green]);
...
; 40   : 	m_RedBrush = CreateSolidBrush(colors[red]);
...
; 41   : 	m_BlueBrush = CreateSolidBrush(colors[blue]);
...
; 42   : 	m_GreyBrush = CreateSolidBrush(colors[grey]);
...
; 43   : 	m_BrownBrush = CreateSolidBrush(colors[brown]);
...
; 44   : 	m_YellowBrush = CreateSolidBrush(colors[yellow]);
...
; 45   : 	m_LightBlueBrush = CreateSolidBrush(RGB(0, 255, 255));
...
; 46   : 	m_DarkGreenBrush = CreateSolidBrush(colors[dark_green]);
...
; 47   : 	m_OrangeBrush = CreateSolidBrush(colors[orange]);
