...
//-----------------------------------------------------------------------------
void Raven_Learning_Bot::Spawn(Vector2D pos)
{
	SetAlive();
...
//-------------------------------- Update -------------------------------------
//
void Raven_Learning_Bot::Update()
{
...
//-----------------------------------------------------------------------------
void Raven_Learning_Bot::UpdateMovement()
{
...
//-----------------------------------------------------------------------------
bool Raven_Learning_Bot::isReadyForTriggerUpdate()const
{
...
//--------------------------- HandleMessage -----------------------------------
//-----------------------------------------------------------------------------
bool Raven_Learning_Bot::HandleMessage(const Telegram& msg)
{
	...
	case Msg_GunshotSound:
		...
		GetSensoryMem()->UpdateWithSoundSource((Raven_Learning_Bot*)msg.ExtraInfo);
...
//----------------------------------------------------------------------------
bool Raven_Learning_Bot::RotateFacingTowardPosition(Vector2D target)
{
...
//--------------------------------- ReduceHealth ----------------------------
void Raven_Learning_Bot::ReduceHealth(unsigned int val)
{
	m_iHealth -= val;
...
//-----------------------------------------------------------------------------
void Raven_Learning_Bot::TakePossession()
{
...
//-----------------------------------------------------------------------------
void Raven_Learning_Bot::Exorcise()
{
	m_bPossessed = false;
...
//----------------------- ChangeWeapon ----------------------------------------
void Raven_Learning_Bot::ChangeWeapon(unsigned int type)
{
...
//-----------------------------------------------------------------------------
double Raven_Learning_Bot::CalculateTimeToReachPosition(Vector2D pos)const
{
...
//-----------------------------------------------------------------------------
bool Raven_Learning_Bot::isAtPosition(Vector2D pos)const
{
...
//-----------------------------------------------------------------------------
bool Raven_Learning_Bot::hasLOSto(Vector2D pos)const
{
...
bool Raven_Learning_Bot::canWalkTo(Vector2D pos)const
{
...
bool Raven_Learning_Bot::canWalkBetween(Vector2D from, Vector2D to)const
{
...
//-----------------------------------------------------------------------------
bool Raven_Learning_Bot::canStepLeft(Vector2D& PositionOfStep)const
{
...
bool Raven_Learning_Bot::canStepRight(Vector2D& PositionOfStep)const
{
	static const double StepDistance = BRadius() * 2;
...
bool Raven_Learning_Bot::canStepForward(Vector2D& PositionOfStep)const
{
	static const double StepDistance = BRadius() * 2;
...
bool Raven_Learning_Bot::canStepBackward(Vector2D& PositionOfStep)const
{
	static const double StepDistance = BRadius() * 2;
...
//
//------------------------------------------------------------------------
void Raven_Learning_Bot::Render()
{
...
//------------------------- SetUpVertexBuffer ---------------------------------
//-----------------------------------------------------------------------------
void Raven_Learning_Bot::SetUpVertexBuffer()
{
...
void Raven_Learning_Bot::RestoreHealthToMaximum() { m_iHealth = m_iMaxHealth; }

void Raven_Learning_Bot::IncreaseHealth(unsigned int val)
{
	m_iHealth += val;
