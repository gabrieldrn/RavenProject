; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26730.0 
	...
	TITLE	D:\BAC_INFORMATIQUE\Intelligence Artificielle\RavenProject\Sources\goals\Goal_AttackTarget.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\bac_informatique\intelligence artificielle\ravenproject\sources\goals\goal_dodgesidetoside.h
...
; 29   : 	Goal_DodgeSideToSide(Raven_Bot* pBot) :Goal<Raven_Bot>(pBot, goal_strafe),
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\bac_informatique\intelligence artificielle\ravenproject\sources\goals\goal_hunttarget.h
...
; 27   : 	Goal_HuntTarget(Raven_Bot* pBot) :Goal_Composite<Raven_Bot>(pBot, goal_hunt_target),
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\bac_informatique\intelligence artificielle\ravenproject\sources\goals\goal_attacktarget.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
...
; 55   : 	//if status is inactive, call Activate()
; 56   : 	ActivateIfInactive();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?ActivateIfInactive@?$Goal@VRaven_Bot@@@@IAEXXZ ; Goal<Raven_Bot>::ActivateIfInactive

; 57   : 
; 58   : 	//process the subgoals
...
; 12   : 
; 13   : 	//if this goal is reactivated then there may be some existing subgoals that
; 14   : 	//must be removed
...
; 16   : 
; 17   : 	//it is possible for a bot's target to die whilst this goal is active so we
; 18   : 	//must test to make sure the bot always has an active target
; 19   : 	if (!m_pOwner->GetTargetSys()->isTargetPresent())
...
; 24   : 	}
; 25   : 
; 26   : 	//if the bot is able to shoot the target (there is LOS between bot and
; 27   : 	//target), then select a tactic to follow while shooting
; 28   : 	if (m_pOwner->GetTargetSys()->isTargetShootable())
...
; 29   : 	{
; 30   : 		//if the bot has space to strafe then do so
; 31   : 		Vector2D dummy;

	lea	ecx, DWORD PTR _dummy$9[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 32   : 		if (m_pOwner->canStepLeft(dummy) || m_pOwner->canStepRight(dummy))
...
; 33   : 		{
; 34   : 			AddSubgoal(new Goal_DodgeSideToSide(m_pOwner));
...
; 35   : 		}
; 36   : 
; 37   : 		//if not able to strafe, head directly at the target's position
; 38   : 		else
...
; 39   : 		{
; 40   : 			AddSubgoal(new Goal_SeekToPosition(m_pOwner, m_pOwner->GetTargetBot()->Pos()));
...
; 42   : 	}
; 43   : 
; 44   : 	//if the target is not visible, go hunt it.
; 45   : 	else
...
; 46   : 	{
; 47   : 		AddSubgoal(new Goal_HuntTarget(m_pOwner));
...
; 60   : 	Raven_Bot* GetTarget()const { return m_pCurrentTarget; }
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\bac_informatique\intelligence artificielle\ravenproject\common\game\basegameentity.h
...
; 95   : 	if (RandFloat() > 0.5) return true;
