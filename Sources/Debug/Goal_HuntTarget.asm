; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26730.0 
	...
	TITLE	D:\BAC_INFORMATIQUE\Intelligence Artificielle\RavenProject\Sources\goals\Goal_HuntTarget.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; Function compile flags: /Odtp /RTCsu
; File d:\bac_informatique\intelligence artificielle\ravenproject\sources\goals\goal_hunttarget.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
...
; 71   : 	//#define SHOW_LAST_RECORDED_POSITION
; 72   : #ifdef SHOW_LAST_RECORDED_POSITION
; 73   :   //render last recorded position as a green circle
; 74   : 	if (m_pOwner->GetTargetSys()->isTargetPresent())
; 75   : 	{
; 76   : 		gdi->GreenPen();
; 77   : 		gdi->RedBrush();
; 78   : 		gdi->Circle(m_pOwner->GetTargetSys()->GetLastRecordedPosition(), 3);
; 79   : 	}
; 80   : #endif
; 81   : 
; 82   : 	//forward the request to the subgoals
; 83   : 	Goal_Composite<Raven_Bot>::Render();
...
; 53   : 	//if status is inactive, call Activate()
; 54   : 	ActivateIfInactive();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?ActivateIfInactive@?$Goal@VRaven_Bot@@@@IAEXXZ ; Goal<Raven_Bot>::ActivateIfInactive

; 55   : 
; 56   : 	m_iStatus = ProcessSubgoals();
...
; 57   : 
; 58   : 	//if target is in view this goal is satisfied
; 59   : 	if (m_pOwner->GetTargetSys()->isTargetWithinFOV())
...
; 15   : 
; 16   : 	//if this goal is reactivated then there may be some existing subgoals that
; 17   : 	//must be removed
; 18   : 	RemoveAllSubgoals();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?RemoveAllSubgoals@?$Goal_Composite@VRaven_Bot@@@@QAEXXZ ; Goal_Composite<Raven_Bot>::RemoveAllSubgoals

; 19   : 
; 20   : 	//it is possible for the target to die whilst this goal is active so we
; 21   : 	//must test to make sure the bot always has an active target
; 22   : 	if (m_pOwner->GetTargetSys()->isTargetPresent())
...
; 23   : 	{
; 24   : 		//grab a local copy of the last recorded position (LRP) of the target
; 25   : 		const Vector2D lrp = m_pOwner->GetTargetSys()->GetLastRecordedPosition();
...
; 26   : 
; 27   : 		//if the bot has reached the LRP and it still hasn't found the target
; 28   : 		//it starts to search by using the explore goal to move to random
; 29   : 		//map locations
; 30   : 		if (lrp.isZero() || m_pOwner->isAtPosition(lrp))
...
; 31   : 		{
; 32   : 			AddSubgoal(new Goal_Explore(m_pOwner));
...
; 37   : 		{
; 38   : 			AddSubgoal(new Goal_MoveToPosition(m_pOwner, lrp));
...
; 40   : 	}
; 41   : 
; 42   : 	//if their is no active target then this goal can be removed from the queue
; 43   : 	else
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\bac_informatique\intelligence artificielle\ravenproject\sources\raven_targetingsystem.h
...
; 40   : 	bool       isTargetPresent()const { return m_pCurrentTarget != 0; }
...
; 30   : 	bool isZero()const { return (x*x + y * y) < MinDouble; }
