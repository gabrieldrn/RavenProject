; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26730.0 
	...
	TITLE	D:\BAC_INFORMATIQUE\Intelligence Artificielle\RavenProject\Sources\Raven_TargetingSystem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 203  : 	Raven_SensoryMemory* const         GetSensoryMem()const { return m_pSensoryMem; }
...
; 151  : 	bool          isAlive()const { return m_Status == alive; }
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\bac_informatique\intelligence artificielle\ravenproject\sources\raven_targetingsystem.cpp
_TEXT	SEGMENT
$T1 = -8						; size = 4
_this$ = -4						; size = 4
___$ReturnUdt$ = 8					; size = 4
