; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26730.0 
	...
	TITLE	D:\Documents\CANADA\COURS\IA\Travaux\RavenProject\Common\fuzzy\FuzzySet_LeftShoulder.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File d:\documents\canada\cours\ia\travaux\ravenproject\common\fuzzy\fuzzyset_leftshoulder.cpp
_TEXT	SEGMENT
tv176 = -20						; size = 8
_grad$1 = -12						; size = 8
_this$ = -4						; size = 4
...
; 12   : 	}
; 13   : 
; 14   : 	//find DOM if right of center
; 15   : 	else if ((val >= m_dPeakPoint) && (val < (m_dPeakPoint + m_dRightOffset)))
...
; 16   : 	{
; 17   : 		double grad = 1.0 / -m_dRightOffset;
...
; 18   : 
; 19   : 		return grad * (val - m_dPeakPoint) + 1.0;
...
; 20   : 	}
; 21   : 
; 22   : 	//find DOM if left of center
; 23   : 	else if ((val < m_dPeakPoint) && (val >= m_dPeakPoint - m_dLeftOffset))
