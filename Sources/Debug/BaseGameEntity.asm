; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26732.1 
	...
	TITLE	E:\UQAC\IA\RavenProject\Common\Game\BaseGameEntity.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG153500 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
	ORG $+4
$SG153501 DB	'e', 00H, ':', 00H, '\', 00H, 'u', 00H, 'q', 00H, 'a', 00H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File e:\uqac\ia\ravenproject\common\game\basegameentity.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_ID$ = 8						; size = 4
