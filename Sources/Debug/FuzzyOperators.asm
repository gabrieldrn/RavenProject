; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27024.1 
	...
	TITLE	D:\Gits\RavenProject\Common\fuzzy\FuzzyOperators.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_1GG@IEIAFIHN@?$AAd?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAs?$AA?2?$AAr?$AAa?$AAv?$AAe?$AAn?$AAp?$AAr@ ; `string'
...
??_C@_1FC@EJGEACIH@?$AA0?$AA?5?$AA?$CG?$AA?$CG?$AA?5?$AA?$CC?$AA?$DM?$AAF?$AAz?$AAO?$AAR?$AA?3?$AA?3?$AAC?$AAl@ DB '0'
	...
	DB	00H, 00H, 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_1GG@IEIAFIHN@?$AAd?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAs?$AA?2?$AAr?$AAa?$AAv?$AAe?$AAn?$AAp?$AAr@
CONST	SEGMENT
??_C@_1GG@IEIAFIHN@?$AAd?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAs?$AA?2?$AAr?$AAa?$AAv?$AAe?$AAn?$AAp?$AAr@ DB 'd'
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\common\fuzzy\fuzzyoperators.h
...
; 86   : 	void ORwithDOM(double val) { assert(0 && "<FzOR::ORwithDOM>: invalid context"); }
	...
	push	86					; 00000056H
	push	OFFSET ??_C@_1GG@IEIAFIHN@?$AAd?$AA?3?$AA?2?$AAg?$AAi?$AAt?$AAs?$AA?2?$AAr?$AAa?$AAv?$AAe?$AAn?$AAp?$AAr@
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\common\fuzzy\fuzzyoperators.cpp
_TEXT	SEGMENT
tv132 = -108						; size = 4
tv165 = -104						; size = 8
tv91 = -96						; size = 4
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\common\fuzzy\fuzzyterm.h
