; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26730.0 
	...
	TITLE	D:\Documents\CANADA\COURS\IA\Travaux\RavenProject\Common\Game\BaseGameEntity.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG153500 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
	ORG $+4
$SG153501 DB	'd', 00H, ':', 00H, '\', 00H, 'd', 00H, 'o', 00H, 'c', 00H
	...
	ORG $+6
$SG153502 DB	'(', 00H, 'v', 00H, 'a', 00H, 'l', 00H, ' ', 00H, '>', 00H
...
; 74   : 	virtual void Read(std::ifstream& is) {}
...
; 73   : 	virtual void Write(std::ostream&  os)const {}
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\documents\canada\cours\ia\travaux\ravenproject\common\game\basegameentity.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_ID$ = 8						; size = 4
...
; 7    : BaseGameEntity::BaseGameEntity(int ID) :m_dBoundingRadius(0.0),
...
; 24   : 	//make sure the val is equal to or greater than the next available ID
; 25   : 	assert((val >= m_iNextValidID) && "<BaseGameEntity::SetID>: invalid ID");

	mov	eax, DWORD PTR _val$[ebp]
	cmp	eax, DWORD PTR ?m_iNextValidID@BaseGameEntity@@0HA ; BaseGameEntity::m_iNextValidID
	jl	SHORT $LN3@SetID
	mov	ecx, OFFSET $SG153500
	test	ecx, ecx
	jne	SHORT $LN4@SetID
$LN3@SetID:
	push	25					; 00000019H
	push	OFFSET $SG153501
	push	OFFSET $SG153502
	call	__wassert
