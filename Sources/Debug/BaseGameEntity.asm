; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27024.1 
	...
	TITLE	D:\Gits\RavenProject\Common\Game\BaseGameEntity.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG153492 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
	ORG $+4
$SG153493 DB	'd', 00H, ':', 00H, '\', 00H, 'g', 00H, 'i', 00H, 't', 00H
	...
	DB	00H
$SG153494 DB	'(', 00H, 'v', 00H, 'a', 00H, 'l', 00H, ' ', 00H, '>', 00H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\common\game\basegameentity.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_ID$ = 8						; size = 4
...
; 25   : 	assert((val >= m_iNextValidID) && "<BaseGameEntity::SetID>: invalid ID");
	...
	jl	SHORT $LN3@SetID
	mov	ecx, OFFSET $SG153492
	test	ecx, ecx
	jne	SHORT $LN4@SetID
$LN3@SetID:
	push	25					; 00000019H
	push	OFFSET $SG153493
	push	OFFSET $SG153494
	call	__wassert
