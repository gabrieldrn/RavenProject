; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27024.1 
	...
	TITLE	D:\Gits\RavenProject\Sources\Raven_TargetingSystem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?GetNeighbours@Raven_TargetingSystem@@QAE?AV?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@XZ ; Raven_TargetingSystem::GetNeighbours
...
; 204  : 	Raven_SensoryMemory* const         GetSensoryMem()const { return m_pSensoryMem; }
...
; 152  : 	bool          isAlive()const { return m_Status == alive; }
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\sources\raven_targetingsystem.cpp
_TEXT	SEGMENT
$T1 = -8						; size = 4
_this$ = -4						; size = 4
___$ReturnUdt$ = 8					; size = 4
?GetNeighbours@Raven_TargetingSystem@@QAE?AV?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@XZ PROC ; Raven_TargetingSystem::GetNeighbours
; _this$ = ecx
...
; 42   : 	return m_pOwner->GetSensoryMem()->GetListOfRecentlySensedOpponents();
...
; 43   : }
	...
	pop	ebp
	ret	4
?GetNeighbours@Raven_TargetingSystem@@QAE?AV?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@XZ ENDP ; Raven_TargetingSystem::GetNeighbours
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\sources\raven_targetingsystem.cpp
_TEXT	SEGMENT
...
; 67   : 	return m_pOwner->GetSensoryMem()->GetTimeOpponentHasBeenOutOfView(m_pCurrentTarget);
...
; 62   : 	return m_pOwner->GetSensoryMem()->GetTimeOpponentHasBeenVisible(m_pCurrentTarget);
...
; 57   : 	return m_pOwner->GetSensoryMem()->GetLastRecordedPositionOfOpponent(m_pCurrentTarget);
...
; 52   : 	return m_pOwner->GetSensoryMem()->isOpponentShootable(m_pCurrentTarget);
...
; 47   : 	return m_pOwner->GetSensoryMem()->isOpponentWithinFOV(m_pCurrentTarget);
...
; 16   : 	double ClosestDistSoFar = MaxDouble;

	movsd	xmm0, QWORD PTR __real@7fefffffffffffff
	movsd	QWORD PTR _ClosestDistSoFar$[ebp], xmm0

; 17   : 	m_pCurrentTarget = 0;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+4], 0

; 18   : 
; 19   : 	//grab a list of all the opponents the owner can sense
; 20   : 	std::list<Raven_Bot*> SensedBots;
...
; 21   : 	SensedBots = m_pOwner->GetSensoryMem()->GetListOfRecentlySensedOpponents();
...
; 22   : 
; 23   : 	std::list<Raven_Bot*>::const_iterator curBot = SensedBots.begin();
...
; 24   : 	for (curBot; curBot != SensedBots.end(); ++curBot)
...
; 25   : 	{
; 26   : 		//make sure the bot is alive and that it is not the owner
; 27   : 		if ((*curBot)->isAlive() && (*curBot != m_pOwner))
...
; 28   : 		{
; 29   : 			double dist = Vec2DDistanceSq((*curBot)->Pos(), m_pOwner->Pos());
...
; 32   : 			{
; 33   : 				ClosestDistSoFar = dist;

	movsd	xmm0, QWORD PTR _dist$8[ebp]
	movsd	QWORD PTR _ClosestDistSoFar$[ebp], xmm0

; 34   : 				m_pCurrentTarget = *curBot;
...
; 7    : Raven_TargetingSystem::Raven_TargetingSystem(Raven_Bot* owner) :m_pOwner(owner),

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _owner$[ebp]
	mov	DWORD PTR [eax], ecx

; 8    : m_pCurrentTarget(0)
