; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27024.1 
	...
	TITLE	D:\Gits\RavenProject\Sources\goals\Goal_FollowPath.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG171526 DB	'<Goal_FollowPath::Activate>: Unrecognized edge type', 00H
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\dev\microsoft visual studio\2017\enterprise\vc\tools\msvc\14.16.27023\include\xlocnum
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\sources\goals\goal_followpath.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\sources\goals\goal_followpath.cpp
_TEXT	SEGMENT
tv166 = -124						; size = 4
tv65 = -120						; size = 4
tv164 = -116						; size = 4
...
; 93   : 	//render all the path waypoints remaining on the path list
; 94   : 	std::list<PathEdge>::iterator it;
...
; 95   : 	for (it = m_Path.begin(); it != m_Path.end(); ++it)
...
; 98   : 		gdi->LineWithArrow(it->Source(), it->Destination(), 5);
...
; 102  : 		gdi->Circle(it->Destination(), 3);
...
; 104  : 
; 105  : 	//forward the request to the subgoals
; 106  : 	Goal_Composite<Raven_Bot>::Render();
...
; 74   : 	//if status is inactive, call Activate()
...
; 78   : 
; 79   : 	//if there are no subgoals present check to see if the path still has edges.
; 80   : 	//remaining. If it does then call activate to grab the next edge.
; 81   : 	if (m_iStatus == completed && !m_Path.empty())
...
; 23   : 
; 24   : 	//get a reference to the next edge
; 25   : 	PathEdge edge = m_Path.front();
...
; 26   : 
; 27   : 	//remove the edge from the path
; 28   : 	m_Path.pop_front();
...
; 29   : 
; 30   : 	//some edges specify that the bot should use a specific behavior when
; 31   : 	//following them. This switch statement queries the edge behavior flag and
; 32   : 	//adds the appropriate goals/s to the subgoal list.
; 33   : 	switch (edge.Behavior())
...
; 34   : 	{
; 35   : 	case NavGraphEdge::normal:
; 36   : 	{
; 37   : 		AddSubgoal(new Goal_TraverseEdge(m_pOwner, edge, m_Path.empty()));
...
; 41   : 
; 42   : 	case NavGraphEdge::goes_through_door:
; 43   : 	{
; 44   : 		//also add a goal that is able to handle opening the door
; 45   : 		AddSubgoal(new Goal_NegotiateDoor(m_pOwner, edge, m_Path.empty()));
...
; 49   : 
; 50   : 	case NavGraphEdge::jump:
; 51   : 	{
; 52   : 		//add subgoal to jump along the edge
; 53   : 	}
; 54   : 
; 55   : 	break;
...
; 56   : 
; 57   : 	case NavGraphEdge::grapple:
; 58   : 	{
; 59   : 		//add subgoal to grapple along the edge
; 60   : 	}
; 61   : 
; 62   : 	break;
...
; 13   : 	std::list<PathEdge> path) :Goal_Composite<Raven_Bot>(pBot, goal_follow_path),
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\sources\navigation\pathedge.h
...
; 265  : 		Vector2D norm = Vec2DNormalize(to - from);
...
; 266  : 
; 267  : 		//calculate where the arrow is attached
; 268  : 		Vector2D CrossingPoint = to - (norm * size);
...
; 269  : 
; 270  : 		//calculate the two extra points required to make the arrowhead
; 271  : 		Vector2D ArrowPoint1 = CrossingPoint + (norm.Perp() * 0.4f * size);
...
; 272  : 		Vector2D ArrowPoint2 = CrossingPoint - (norm.Perp() * 0.4f * size);
...
; 273  : 
; 274  : 		//draw the line
; 275  : 		MoveToEx(m_hdc, (int)from.x, (int)from.y, NULL);
...
; 276  : 		LineTo(m_hdc, (int)CrossingPoint.x, (int)CrossingPoint.y);
...
; 277  : 
; 278  : 		//draw the arrowhead (filled with the currently selected brush)
; 279  : 		POINT p[3];
; 280  : 
; 281  : 		p[0] = VectorToPOINT(ArrowPoint1);
...
; 282  : 		p[1] = VectorToPOINT(ArrowPoint2);
...
; 284  : 
; 285  : 		SetPolyFillMode(m_hdc, WINDING);
...
; 159  : 	void RedBrush() { if (m_hdc)SelectObject(m_hdc, m_RedBrush); }
...
; 132  : 	void BlackPen() { if (m_hdc) { SelectObject(m_hdc, m_BlackPen); } }
...
; 251  : 
; 252  : 	double vector_length = vec.Length();
...
; 253  : 
; 254  : 	if (vector_length > std::numeric_limits<double>::epsilon())
