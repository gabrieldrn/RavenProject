; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27024.1 
	...
	TITLE	D:\Gits\RavenProject\Common\misc\WindowUtils.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG152307 DB	'Error', 00H
	ORG $+2
$SG152311 DB	'Error', 00H
	ORG $+2
$SG152402 DB	'*.*', 00H
$SG152403 DB	'All Files (*.*)', 00H
$SG152404 DB	'*.', 00H
CONST	ENDS
...
PUBLIC	??_C@_0FJ@OJGHOLHK@d?3?2dev?2microsoft?5visual?5studio?2@ ; `string'
...
??_7facet@locale@std@@6B@ DD FLAT:??_R4facet@locale@std@@6B@ ; std::locale::facet::`vftable'
	...
	DD	FLAT:?_Decref@facet@locale@std@@UAEPAV_Facet_base@3@XZ
CONST	ENDS
;	COMDAT ??_C@_0FJ@OJGHOLHK@d?3?2dev?2microsoft?5visual?5studio?2@
CONST	SEGMENT
??_C@_0FJ@OJGHOLHK@d?3?2dev?2microsoft?5visual?5studio?2@ DB 'd:\dev\micr'
	DB	'osoft visual studio\2017\enterprise\vc\tools\msvc\14.16.27023'
	DB	'\include\xlocale', 00H			; `string'
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\dev\microsoft visual studio\2017\enterprise\vc\tools\msvc\14.16.27023\include\ostream
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\dev\microsoft visual studio\2017\enterprise\vc\tools\msvc\14.16.27023\include\memory
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\dev\microsoft visual studio\2017\enterprise\vc\tools\msvc\14.16.27023\include\iomanip
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\dev\microsoft visual studio\2017\enterprise\vc\tools\msvc\14.16.27023\include\sstream
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\dev\microsoft visual studio\2017\enterprise\vc\tools\msvc\14.16.27023\include\streambuf
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\dev\microsoft visual studio\2017\enterprise\vc\tools\msvc\14.16.27023\include\ios
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\dev\microsoft visual studio\2017\enterprise\vc\tools\msvc\14.16.27023\include\system_error
...
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\common\misc\stream_utility_functions.h
...
; 23   : 
; 24   : 	buffer << std::fixed << std::setprecision(precision) << t;
...
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\common\misc\windowutils.cpp
_TEXT	SEGMENT
$T1 = -42						; size = 1
$T2 = -41						; size = 1
_s$ = -36						; size = 28
...
; 53   : 	{
; 54   : 		BufferLength = 0; return false;
...
; 296  : 	return Vector2D((double)p.x, (double)p.y);
...
; 225  : 
; 226  : 	return windowRect.right - windowRect.left;
...
; 209  : 	RECT windowRect;
; 210  : 
; 211  : 	GetWindowRect(hwnd, &windowRect);
...
; 212  : 
; 213  : 	return windowRect.bottom - windowRect.top;
...
; 175  : 	//does this window have a menu. If so set a flag to true
; 176  : 	HMENU hwndMenu = GetMenu(hwnd);
...
; 177  : 	bool bMenu = false;

	mov	BYTE PTR _bMenu$[ebp], 0

; 178  : 	if (hwndMenu) bMenu = true;
...
; 179  : 
; 180  : 	//create a rect of the desired window size
; 181  : 	RECT DesiredSize;
; 182  : 	DesiredSize.left = 0;

	mov	DWORD PTR _DesiredSize$[ebp], 0

; 183  : 	DesiredSize.top = 0;

	mov	DWORD PTR _DesiredSize$[ebp+4], 0

; 184  : 	DesiredSize.right = cx;

	mov	ecx, DWORD PTR _cx$[ebp]
	mov	DWORD PTR _DesiredSize$[ebp+8], ecx

; 185  : 	DesiredSize.bottom = cy;

	mov	edx, DWORD PTR _cy$[ebp]
	mov	DWORD PTR _DesiredSize$[ebp+12], edx

; 186  : 
; 187  : 	//determine the size the window should be given the desired client area
; 188  : 	AdjustWindowRectEx(&DesiredSize,
...
; 189  : 		WS_OVERLAPPED | WS_VISIBLE | WS_CAPTION | WS_SYSMENU,
; 190  : 		bMenu,
; 191  : 		NULL);
; 192  : 
; 193  : 	//resize the window to fit
; 194  : 	SetWindowPos(hwnd,
...
; 195  : 		NULL,
; 196  : 		GetSystemMetrics(SM_CXSCREEN) / 2 - cx / 2,
; 197  : 		GetSystemMetrics(SM_CYSCREEN) / 2 - cy / 2,
; 198  : 		DesiredSize.right,
; 199  : 		DesiredSize.bottom,
; 200  : 		SWP_NOZORDER);
; 201  : }
...
; 159  : 	OPENFILENAME ofn; FileInitialize(hwnd, ofn, defaultFileTypeDescription, defaultFileExtension);
...
; 142  : 
; 143  : 	FileInitialize(hwnd, ofn, defaultFileTypeDescription, defaultFileExtension);
...
; 146  : 	ofn.lpstrFile = pstrFileName;

	mov	edx, DWORD PTR _pstrFileName$[ebp]
	mov	DWORD PTR _ofn$[ebp+28], edx

; 147  : 	ofn.lpstrFileTitle = pstrTitleName;

	mov	eax, DWORD PTR _pstrTitleName$[ebp]
	mov	DWORD PTR _ofn$[ebp+36], eax

; 148  : 	ofn.Flags = OFN_HIDEREADONLY | OFN_CREATEPROMPT;

	mov	DWORD PTR _ofn$[ebp+52], 8196		; 00002004H

; 149  : 
; 150  : 	return GetOpenFileName(&ofn);
...
; 103  : 	std::string filter = defaultFileTypeDescription + '\0' + "*." + defaultFileExtension + '\0' +
; 104  : 		"All Files (*.*)" + '\0' + "*.*" + '\0' + '\0';
...
; 105  : 
; 106  : 	static TCHAR szFilter[255];
; 107  : 
; 108  : 	for (unsigned int i = 0; i < filter.size(); ++i)
...
; 120  : 	ofn.lpstrFile = NULL;          // Set in Open and Close functions
...
; 122  : 	ofn.lpstrFileTitle = NULL;          // Set in Open and Close functions

	mov	edx, DWORD PTR _ofn$[ebp]
	mov	DWORD PTR [edx+36], 0

; 123  : 	ofn.nMaxFileTitle = MAX_PATH;

	mov	eax, DWORD PTR _ofn$[ebp]
	mov	DWORD PTR [eax+40], 260			; 00000104H

; 124  : 	ofn.lpstrInitialDir = NULL;

	mov	ecx, DWORD PTR _ofn$[ebp]
	mov	DWORD PTR [ecx+44], 0

; 125  : 	ofn.lpstrTitle = NULL;

	mov	edx, DWORD PTR _ofn$[ebp]
	mov	DWORD PTR [edx+48], 0

; 126  : 	ofn.Flags = 0;             // Set in Open and Close functions

	mov	eax, DWORD PTR _ofn$[ebp]
	mov	DWORD PTR [eax+52], 0

; 127  : 	ofn.nFileOffset = 0;

	xor	ecx, ecx
	mov	edx, DWORD PTR _ofn$[ebp]
	mov	WORD PTR [edx+56], cx

; 128  : 	ofn.nFileExtension = 0;

	xor	eax, eax
	mov	ecx, DWORD PTR _ofn$[ebp]
	mov	WORD PTR [ecx+58], ax

; 129  : 	ofn.lpstrDefExt = defaultFileExtension.c_str();
...
; 130  : 	ofn.lCustData = 0L;

	mov	eax, DWORD PTR _ofn$[ebp]
	mov	DWORD PTR [eax+64], 0

; 131  : 	ofn.lpfnHook = NULL;

	mov	ecx, DWORD PTR _ofn$[ebp]
	mov	DWORD PTR [ecx+68], 0

; 132  : 	ofn.lpTemplateName = NULL;
...
; 87   : 
; 88   : 	ScreenToClient(hwnd, &MousePos);
...
; 89   : 
; 90   : 	return POINTtoVector(MousePos);
...
; 76   : 
; 77   : 	ScreenToClient(GetActiveWindow(), &MousePos);
...
; 78   : 
; 79   : 	return POINTtoVector(MousePos);
...
; 67   : 	MessageBox(NULL, msg, "Error", MB_OK);
...
; 62   : 	MessageBox(NULL, msg.c_str(), "Error", MB_OK);

	mov	esi, esp
	push	0
	push	OFFSET $SG152307
...
; 31   : 	{
; 32   : 		ChangeMenuState(hwnd, MenuItem, MFS_CHECKED);
...
; 35   : 	{
; 36   : 		ChangeMenuState(hwnd, MenuItem, MFS_UNCHECKED);
...
; 14   : 	MENUITEMINFO mi;
; 15   : 
; 16   : 	mi.cbSize = sizeof(MENUITEMINFO);

	mov	DWORD PTR _mi$[ebp], 48			; 00000030H

; 17   : 	mi.fMask = MIIM_STATE;
...
; 19   : 
; 20   : 	SetMenuItemInfo(GetMenu(hwnd), MenuItem, false, &mi);
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\dev\microsoft visual studio\2017\enterprise\vc\tools\msvc\14.16.27023\include\xiosbase
...
$LN4@operator:
	push	75					; 0000004bH
	push	OFFSET ??_C@_0FJ@OJGHOLHK@d?3?2dev?2microsoft?5visual?5studio?2@
	push	2
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\dev\microsoft visual studio\2017\enterprise\vc\tools\msvc\14.16.27023\include\xfacet
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\dev\microsoft visual studio\2017\enterprise\vc\tools\msvc\14.16.27023\include\xlocinfo
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\dev\microsoft visual studio\2017\enterprise\vc\tools\msvc\14.16.27023\include\vcruntime_typeinfo.h
