; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26730.0 
	...
	TITLE	D:\Utilisateurs\Samuel\Mes documents\Cours\UQAC\IA\RavenProject\Common\Messaging\MessageDispatcher.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0GH@GBBOINM@c?3?2program?5files?5?$CIx86?$CJ?2microsof@ ; `string'
PUBLIC	??_C@_1MO@GGIJONIB@?$AAc?$AA?3?$AA?2?$AAp?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAf?$AAi?$AAl?$AAe@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1MO@GGIJONIB@?$AAc?$AA?3?$AA?2?$AAp?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAf?$AAi?$AAl?$AAe@
CONST	SEGMENT
??_C@_1MO@GGIJONIB@?$AAc?$AA?3?$AA?2?$AAp?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAf?$AAi?$AAl?$AAe@ DB 'c'
...
CONST	ENDS
;	COMDAT ??_C@_0GH@GBBOINM@c?3?2program?5files?5?$CIx86?$CJ?2microsof@
CONST	SEGMENT
??_C@_0GH@GBBOINM@c?3?2program?5files?5?$CIx86?$CJ?2microsof@ DB 'c:\prog'
	DB	'ram files (x86)\microsoft visual studio\2017\enterprise\vc\to'
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\program files (x86)\microsoft visual studio\2017\enterprise\vc\tools\msvc\14.15.26726\include\xtree
...
$LN7@operator:
	...
	push	0
	push	275					; 00000113H
	push	OFFSET ??_C@_0GH@GBBOINM@c?3?2program?5files?5?$CIx86?$CJ?2microsof@
	push	2
	call	__CrtDbgReport
	add	esp, 24					; 00000018H
	cmp	eax, 1
...
$LN11@operator:
	push	0
	push	275					; 00000113H
	push	OFFSET ??_C@_1MO@GGIJONIB@?$AAc?$AA?3?$AA?2?$AAp?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAf?$AAi?$AAl?$AAe@
...
text$yd	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\utilisateurs\samuel\mes documents\cours\uqac\ia\ravenproject\common\misc\framecounter.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\utilisateurs\samuel\mes documents\cours\uqac\ia\ravenproject\common\messaging\messagedispatcher.cpp
_TEXT	SEGMENT
tv207 = -124						; size = 4
tv204 = -120						; size = 4
tv217 = -116						; size = 4
...
; Function compile flags: /Odtp /RTCsu
; File d:\utilisateurs\samuel\mes documents\cours\uqac\ia\ravenproject\common\messaging\messagedispatcher.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\program files (x86)\microsoft visual studio\2017\enterprise\vc\tools\msvc\14.15.26726\include\set
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\utilisateurs\samuel\mes documents\cours\uqac\ia\ravenproject\common\messaging\telegram.h
