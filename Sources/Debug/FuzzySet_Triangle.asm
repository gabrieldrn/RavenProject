; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26730.0 
	...
	TITLE	D:\Documents\CANADA\COURS\IA\Travaux\RavenProject\Common\fuzzy\FuzzySet_Triangle.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File d:\documents\canada\cours\ia\travaux\ravenproject\common\fuzzy\fuzzyset_triangle.cpp
_TEXT	SEGMENT
tv200 = -36						; size = 8
tv186 = -28						; size = 8
_grad$1 = -20						; size = 8
...
; 5    : 	//test for the case where the triangle's left or right offsets are zero
; 6    : 	//(to prevent divide by zero errors below)
; 7    : 	if ((isEqual(m_dRightOffset, 0.0) && (isEqual(m_dPeakPoint, val))) ||
...
; 8    : 		(isEqual(m_dLeftOffset, 0.0) && (isEqual(m_dPeakPoint, val))))
; 9    : 	{
; 10   : 		return 1.0;
...
; 11   : 	}
; 12   : 
; 13   : 	//find DOM if left of center
; 14   : 	if ((val <= m_dPeakPoint) && (val >= (m_dPeakPoint - m_dLeftOffset)))
...
; 15   : 	{
; 16   : 		double grad = 1.0 / m_dLeftOffset;
...
; 17   : 
; 18   : 		return grad * (val - (m_dPeakPoint - m_dLeftOffset));
...
; 19   : 	}
; 20   : 	//find DOM if right of center
; 21   : 	else if ((val > m_dPeakPoint) && (val < (m_dPeakPoint + m_dRightOffset)))
...
; 22   : 	{
; 23   : 		double grad = 1.0 / -m_dRightOffset;
...
; 24   : 
; 25   : 		return grad * (val - m_dPeakPoint) + 1.0;
...
; 26   : 	}
; 27   : 	//out of range of this FLV, return zero
; 28   : 	else
