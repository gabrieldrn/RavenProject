; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27024.1 
	...
	TITLE	D:\Gits\RavenProject\Sources\goals\Goal_AdjustRange.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\sources\raven_steeringbehaviors.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\sources\goals\goal_adjustrange.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
...
; 21   : 	//if status is inactive, call Activate()
; 22   : 	ActivateIfInactive();
...
; 23   : 
; 24   : 	/*
; 25   : 	if (m_pOwner->GetCurrentWeapon()->isInIdealWeaponRange())
; 26   : 	{
; 27   : 	  m_iStatus = completed;
; 28   : 	}
; 29   :   */
; 30   : 	return m_iStatus;
...
; 14   : 	m_pOwner->GetSteering()->SetTarget(m_pOwner->GetTargetBot()->Pos());
...
; 6    : Goal_AdjustRange::Goal_AdjustRange(Raven_Bot* pBot) :Goal<Raven_Bot>(pBot, goal_adjust_range),
