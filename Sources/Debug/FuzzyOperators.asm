; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26732.1 
	...
	TITLE	E:\UQAC\IA\RavenProject\Common\fuzzy\FuzzyOperators.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_1GM@EBNIIEPB@?$AAe?$AA?3?$AA?2?$AAu?$AAq?$AAa?$AAc?$AA?2?$AAi?$AAa?$AA?2?$AAr?$AAa?$AAv?$AAe@ ; `string'
...
??_C@_1FC@EJGEACIH@?$AA0?$AA?5?$AA?$CG?$AA?$CG?$AA?5?$AA?$CC?$AA?$DM?$AAF?$AAz?$AAO?$AAR?$AA?3?$AA?3?$AAC?$AAl@ DB '0'
	...
	DB	00H, 00H, 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_1GM@EBNIIEPB@?$AAe?$AA?3?$AA?2?$AAu?$AAq?$AAa?$AAc?$AA?2?$AAi?$AAa?$AA?2?$AAr?$AAa?$AAv?$AAe@
CONST	SEGMENT
??_C@_1GM@EBNIIEPB@?$AAe?$AA?3?$AA?2?$AAu?$AAq?$AAa?$AAc?$AA?2?$AAi?$AAa?$AA?2?$AAr?$AAa?$AAv?$AAe@ DB 'e'
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File e:\uqac\ia\ravenproject\common\fuzzy\fuzzyoperators.h
...
; 86   : 	void ORwithDOM(double val) { assert(0 && "<FzOR::ORwithDOM>: invalid context"); }
	...
	push	86					; 00000056H
	push	OFFSET ??_C@_1GM@EBNIIEPB@?$AAe?$AA?3?$AA?2?$AAu?$AAq?$AAa?$AAc?$AA?2?$AAi?$AAa?$AA?2?$AAr?$AAa?$AAv?$AAe@
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File e:\uqac\ia\ravenproject\common\fuzzy\fuzzyoperators.cpp
_TEXT	SEGMENT
tv132 = -108						; size = 4
tv165 = -104						; size = 8
tv91 = -96						; size = 4
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File e:\uqac\ia\ravenproject\common\fuzzy\fuzzyterm.h
