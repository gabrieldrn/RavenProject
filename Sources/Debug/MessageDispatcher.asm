; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27024.1 
	...
	TITLE	D:\Gits\RavenProject\Common\Messaging\MessageDispatcher.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0FH@EDGPNECH@d?3?2dev?2microsoft?5visual?5studio?2@ ; `string'
PUBLIC	??_C@_1KO@HNNOEBJO@?$AAd?$AA?3?$AA?2?$AAd?$AAe?$AAv?$AA?2?$AAm?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1KO@HNNOEBJO@?$AAd?$AA?3?$AA?2?$AAd?$AAe?$AAv?$AA?2?$AAm?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf@
CONST	SEGMENT
??_C@_1KO@HNNOEBJO@?$AAd?$AA?3?$AA?2?$AAd?$AAe?$AAv?$AA?2?$AAm?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf@ DB 'd'
...
CONST	ENDS
;	COMDAT ??_C@_0FH@EDGPNECH@d?3?2dev?2microsoft?5visual?5studio?2@
CONST	SEGMENT
??_C@_0FH@EDGPNECH@d?3?2dev?2microsoft?5visual?5studio?2@ DB 'd:\dev\micr'
	DB	'osoft visual studio\2017\enterprise\vc\tools\msvc\14.16.27023'
	DB	'\include\xtree', 00H			; `string'
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\dev\microsoft visual studio\2017\enterprise\vc\tools\msvc\14.16.27023\include\xtree
...
$LN7@operator:
	...
	push	0
	push	275					; 00000113H
	push	OFFSET ??_C@_0FH@EDGPNECH@d?3?2dev?2microsoft?5visual?5studio?2@
	push	2
	call	__CrtDbgReport
	add	esp, 24					; 00000018H
	cmp	eax, 1
...
$LN11@operator:
	push	0
	push	275					; 00000113H
	push	OFFSET ??_C@_1KO@HNNOEBJO@?$AAd?$AA?3?$AA?2?$AAd?$AAe?$AAv?$AA?2?$AAm?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf@
...
text$yd	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\common\misc\framecounter.h
...
; 26   : 	long GetCurrentFrame() { return m_lCount; }
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\common\messaging\messagedispatcher.cpp
_TEXT	SEGMENT
tv207 = -124						; size = 4
tv204 = -120						; size = 4
tv217 = -116						; size = 4
...
; 104  : 	//first get current time
; 105  : 	double CurrentTime = TickCounter->GetCurrentFrame();
...
; 106  : 
; 107  : 	//now peek at the queue to see if any telegrams need dispatching.
; 108  : 	//remove all telegrams from the front of the queue that have gone
; 109  : 	//past their sell by date
; 110  : 	while (!PriorityQ.empty() &&
; 111  : 		(PriorityQ.begin()->DispatchTime < CurrentTime) &&
...
; 112  : 		(PriorityQ.begin()->DispatchTime > 0))
; 113  : 	{
; 114  : 		//read the telegram from the front of the queue
; 115  : 		const Telegram& telegram = *PriorityQ.begin();
...
; 116  : 
; 117  : 		//find the recipient
; 118  : 		BaseGameEntity* pReceiver = EntityMgr->GetEntityFromID(telegram.Receiver);
...
; 119  : 
; 120  : #ifdef SHOW_MESSAGING_INFO
; 121  : 		debug_con << "\nQueued telegram ready for dispatch: Sent to "
; 122  : 			<< pReceiver->ID() << ". Msg is " << telegram.Msg << "";
; 123  : #endif
; 124  : 
; 125  : 		//send the telegram to the recipient
; 126  : 		Discharge(pReceiver, telegram);
...
; 127  : 
; 128  : 		//remove it from the queue
; 129  : 		PriorityQ.erase(PriorityQ.begin());
...
; 50   : 	//get a pointer to the receiver
; 51   : 	BaseGameEntity* pReceiver = EntityMgr->GetEntityFromID(receiver);
...
; 52   : 
; 53   : 	//make sure the receiver is valid
; 54   : 	if (pReceiver == NULL)

	cmp	DWORD PTR _pReceiver$[ebp], 0
	jne	SHORT $LN2@DispatchMs

; 55   : 	{
; 56   : #ifdef SHOW_MESSAGING_INFO
...
; 61   : 	}
; 62   : 
; 63   : 	//create the telegram
; 64   : 	Telegram telegram(0, sender, receiver, msg, AdditionalInfo);
...
; 65   : 
; 66   : 	//if there is no delay, route telegram immediately
; 67   : 	if (delay <= 0.0)
...
; 68   : 	{
; 69   : #ifdef SHOW_MESSAGING_INFO
; 70   : 		debug_con << "\nTelegram dispatched at time: " << TickCounter->GetCurrentFrame()
; 71   : 			<< " by " << sender << " for " << receiver
; 72   : 			<< ". Msg is " << msg << "";
; 73   : #endif
; 74   : 
; 75   : 		//send the telegram to the recipient
; 76   : 		Discharge(pReceiver, telegram);
...
; 77   : 	}
; 78   : 
; 79   : 	//else calculate the time when the telegram should be dispatched
; 80   : 	else
...
; 81   : 	{
; 82   : 		double CurrentTime = TickCounter->GetCurrentFrame();
...
; 83   : 
; 84   : 		telegram.DispatchTime = CurrentTime + delay;
...
; 85   : 
; 86   : 		//and put it in the queue
; 87   : 		PriorityQ.insert(telegram);
...
; 88   : 
; 89   : #ifdef SHOW_MESSAGING_INFO
; 90   : 		debug_con << "\nDelayed telegram from " << sender << " recorded at time "
; 91   : 			<< TickCounter->GetCurrentFrame() << " for " << receiver
; 92   : 			<< ". Msg is " << msg << "";
; 93   : #endif
; 94   : 	}
; 95   : }
...
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\common\messaging\messagedispatcher.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\dev\microsoft visual studio\2017\enterprise\vc\tools\msvc\14.16.27023\include\set
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\common\messaging\telegram.h
...
; 77   : 	{
; 78   : 		return  (t1.DispatchTime < t2.DispatchTime);
...
; 63   : 	return (fabs(t1.DispatchTime - t2.DispatchTime) < SmallestDelay) &&
...
; 64   : 		(t1.Sender == t2.Sender) &&
; 65   : 		(t1.Receiver == t2.Receiver) &&
; 66   : 		(t1.Msg == t2.Msg);
; 67   : }
...
; 47   : 		void*  info = NULL) : DispatchTime(time),
