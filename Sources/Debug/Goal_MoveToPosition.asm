; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27024.1 
	...
	TITLE	D:\Gits\RavenProject\Sources\goals\Goal_MoveToPosition.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\sources\goals\goal_movetoposition.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
...
; 89   : 	//forward the request to the subgoals
; 90   : 	Goal_Composite<Raven_Bot>::Render();
...
; 95   : 	gdi->Circle(m_vDestination, 6);
...
; 98   : 	gdi->Circle(m_vDestination, 4);
...
; 101  : 	gdi->Circle(m_vDestination, 2);
...
; 53   : 	//first, pass the message down the goal hierarchy
; 54   : 	bool bHandled = ForwardMessageToFrontMostSubgoal(msg);
...
; 55   : 
; 56   : 	//if the msg was not handled, test to see if this goal can handle it
; 57   : 	if (bHandled == false)
...
; 60   : 		{
; 61   : 		case Msg_PathReady:
; 62   : 
; 63   : 			//clear any existing goals
; 64   : 			RemoveAllSubgoals();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?RemoveAllSubgoals@?$Goal_Composite@VRaven_Bot@@@@QAEXXZ ; Goal_Composite<Raven_Bot>::RemoveAllSubgoals

; 65   : 
; 66   : 			AddSubgoal(new Goal_FollowPath(m_pOwner,
...
; 67   : 				m_pOwner->GetPathPlanner()->GetPath()));
; 68   : 
; 69   : 			return true; //msg handled
...
; 37   : 	//if status is inactive, call Activate()
; 38   : 	ActivateIfInactive();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?ActivateIfInactive@?$Goal@VRaven_Bot@@@@IAEXXZ ; Goal<Raven_Bot>::ActivateIfInactive

; 39   : 
; 40   : 	//process the subgoals
; 41   : 	m_iStatus = ProcessSubgoals();
...
; 42   : 
; 43   : 	//if any of the subgoals have failed then this goal re-plans
; 44   : 	ReactivateIfFailed();
...
; 17   : 
; 18   : 	//make sure the subgoal list is clear.
...
; 20   : 
; 21   : 	//requests a path to the target position from the path planner. Because, for
; 22   : 	//demonstration purposes, the Raven path planner uses time-slicing when
; 23   : 	//processing the path requests the bot may have to wait a few update cycles
; 24   : 	//before a path is calculated. Consequently, for appearances sake, it just
; 25   : 	//seeks directly to the target position whilst it's awaiting notification
; 26   : 	//that the path planning request has succeeded/failed
; 27   : 	if (m_pOwner->GetPathPlanner()->RequestPathToPosition(m_vDestination))
...
; 28   : 	{
; 29   : 		AddSubgoal(new Goal_SeekToPosition(m_pOwner, m_vDestination));
...
; 163  : 	void YellowBrush() { if (m_hdc)SelectObject(m_hdc, m_YellowBrush); }
...
; 139  : 	void YellowPen() { if (m_hdc) { SelectObject(m_hdc, m_YellowPen); } }
