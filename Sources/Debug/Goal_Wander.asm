; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26732.1 
	...
	TITLE	D:\Documents\CANADA\COURS\IA\Travaux\RavenProject\Sources\goals\Goal_Wander.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; 190  : 	void WanderOff() { if (On(wander)) m_iFlags ^= wander; }
...
; 184  : 	void WanderOn() { m_iFlags |= wander; }
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\documents\canada\cours\ia\travaux\ravenproject\sources\goals\goal_wander.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
...
; 28   : 	m_pOwner->GetSteering()->WanderOff();
...
; 18   : 	//if status is inactive, call Activate()
; 19   : 	ActivateIfInactive();
...
; 10   : 
; 11   : 	m_pOwner->GetSteering()->WanderOn();
