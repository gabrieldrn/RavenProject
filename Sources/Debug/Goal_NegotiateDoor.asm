; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26730.0 
	...
	TITLE	D:\BAC_INFORMATIQUE\Intelligence Artificielle\RavenProject\Sources\goals\Goal_NegotiateDoor.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\bac_informatique\intelligence artificielle\ravenproject\sources\goals\goal_negotiatedoor.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\bac_informatique\intelligence artificielle\ravenproject\sources\goals\goal_negotiatedoor.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
...
; 28   : 
; 29   : 	//if this goal is reactivated then there may be some existing subgoals that
; 30   : 	//must be removed
; 31   : 	RemoveAllSubgoals();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?RemoveAllSubgoals@?$Goal_Composite@VRaven_Bot@@@@QAEXXZ ; Goal_Composite<Raven_Bot>::RemoveAllSubgoals

; 32   : 
; 33   : 	//get the position of the closest navigable switch
; 34   : 	Vector2D posSw = m_pOwner->GetWorld()->GetPosOfClosestSwitch(m_pOwner->Pos(),
...
; 35   : 		m_PathEdge.DoorID());
; 36   : 
; 37   : 	//because goals are *pushed* onto the front of the subgoal list they must
; 38   : 	//be added in reverse order.
; 39   : 
; 40   : 	//first the goal to traverse the edge that passes through the door
; 41   : 	AddSubgoal(new Goal_TraverseEdge(m_pOwner, m_PathEdge, m_bLastEdgeInPath));
...
; 42   : 
; 43   : 	//next, the goal that will move the bot to the beginning of the edge that
; 44   : 	//passes through the door
; 45   : 	AddSubgoal(new Goal_MoveToPosition(m_pOwner, m_PathEdge.Source()));
...
; 46   : 
; 47   : 	//finally, the Goal that will direct the bot to the location of the switch
; 48   : 	AddSubgoal(new Goal_MoveToPosition(m_pOwner, posSw));
...
; 16   : 	bool         LastEdge) :Goal_Composite<Raven_Bot>(pBot, goal_negotiate_door),
