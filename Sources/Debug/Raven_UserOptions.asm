; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26730.0 
	...
	TITLE	D:\Utilisateurs\Samuel\Mes documents\Cours\UQAC\IA\RavenProject\Sources\Raven_UserOptions.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File d:\utilisateurs\samuel\mes documents\cours\uqac\ia\ravenproject\sources\raven_useroptions.cpp
_TEXT	SEGMENT
__$EHRec$ = -12						; size = 12
...
; 5    : 	static Raven_UserOptions instance;
...
; 9    : Raven_UserOptions::Raven_UserOptions() :m_bShowGraph(false),

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax], 0

; 20   : m_bShowNodeIndices(false),

	mov	ecx, DWORD PTR _this$[ebp]
	mov	BYTE PTR [ecx+1], 0

; 10   : m_bShowPathOfSelectedBot(true),

	mov	edx, DWORD PTR _this$[ebp]
	mov	BYTE PTR [edx+2], 1

; 15   : m_bShowTargetOfSelectedBot(false),

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+3], 0

; 21   : m_bShowOpponentsSensedBySelectedBot(true),

	mov	ecx, DWORD PTR _this$[ebp]
	mov	BYTE PTR [ecx+4], 1

; 16   : m_bOnlyShowBotsInTargetsFOV(false),

	mov	edx, DWORD PTR _this$[ebp]
	mov	BYTE PTR [edx+5], 0

; 18   : m_bShowGoalsOfSelectedBot(true),

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+6], 1

; 19   : m_bShowGoalAppraisals(true),

	mov	ecx, DWORD PTR _this$[ebp]
	mov	BYTE PTR [ecx+7], 1

; 22   : m_bShowWeaponAppraisals(false)

	mov	edx, DWORD PTR _this$[ebp]
	mov	BYTE PTR [edx+8], 0

; 11   : m_bSmoothPathsQuick(false),

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+9], 0

; 12   : m_bSmoothPathsPrecise(false),

	mov	ecx, DWORD PTR _this$[ebp]
	mov	BYTE PTR [ecx+10], 0

; 13   : m_bShowBotIDs(false),

	mov	edx, DWORD PTR _this$[ebp]
	mov	BYTE PTR [edx+11], 0

; 14   : m_bShowBotHealth(true),

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+12], 1

; 17   : m_bShowScore(false),
