; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27024.1 
	...
	TITLE	D:\Gits\RavenProject\Sources\armory\Raven_Projectile.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\sources\raven_game.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\sources\armory\raven_projectile.cpp
_TEXT	SEGMENT
tv241 = -140						; size = 8
tv248 = -132						; size = 8
tv236 = -124						; size = 8
...
; 45   : 	//this will hold any bots that are intersecting with the line segment
; 46   : 	std::list<Raven_Bot*> hits;
...
; 47   : 
; 48   : 	//iterate through all entities checking against the line segment FromTo
; 49   : 	std::list<Raven_Bot*>::const_iterator curBot;
...
; 50   : 	for (curBot = m_pWorld->GetAllBots().begin();
...
; 51   : 		curBot != m_pWorld->GetAllBots().end();
...
; 53   : 	{
; 54   : 		//make sure we don't check against the shooter of the projectile
; 55   : 		if (((*curBot)->ID() != m_iShooterID))
...
; 56   : 		{
; 57   : 			//if the distance to FromTo is less than the entities bounding radius then
; 58   : 			//there is an intersection so add it to hits
; 59   : 			if (DistToLineSegment(From, To, (*curBot)->Pos()) < (*curBot)->BRadius())
...
; 37   : 
; 38   : 	return ClosestIntersectingBot;
...
; 85   : 	double       BRadius()const { return m_dBoundingRadius; }
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\gits\ravenproject\common\2d\geometry.h
...
; 135  : 	//if the angle is obtuse between PA and AB is obtuse then the closest
; 136  : 	//vertex must be A
; 137  : 	double dotA = (P.x - A.x)*(B.x - A.x) + (P.y - A.y)*(B.y - A.y);
...
; 138  : 
; 139  : 	if (dotA <= 0) return Vec2DDistance(A, P);
...
; 140  : 
; 141  : 	//if the angle is obtuse between PB and AB is obtuse then the closest
; 142  : 	//vertex must be B
; 143  : 	double dotB = (P.x - B.x)*(A.x - B.x) + (P.y - B.y)*(A.y - B.y);
...
; 144  : 
; 145  : 	if (dotB <= 0) return Vec2DDistance(B, P);
...
; 146  : 
; 147  : 	//calculate the point along AB that is the closest to P
; 148  : 	Vector2D Point = A + ((B - A) * dotA) / (dotA + dotB);
...
; 149  : 
; 150  : 	//calculate the distance P-Point
; 151  : 	return Vec2DDistance(P, Point);
...
; 273  : 	double ySeparation = v2.y - v1.y;
...
; 274  : 	double xSeparation = v2.x - v1.x;
...
; 275  : 
; 276  : 	return ySeparation * ySeparation + xSeparation * xSeparation;
...
; 265  : 	double ySeparation = v2.y - v1.y;
...
; 266  : 	double xSeparation = v2.x - v1.x;
...
; 267  : 
; 268  : 	return sqrt(ySeparation*ySeparation + xSeparation * xSeparation);
