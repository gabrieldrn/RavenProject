; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26730.0 
	...
	TITLE	D:\BAC_INFORMATIQUE\Intelligence Artificielle\RavenProject\Sources\goals\Goal_GetItem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG169734 DB	'Goal_GetItem cannot determine item type', 00H
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\bac_informatique\intelligence artificielle\ravenproject\common\triggers\trigger.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\bac_informatique\intelligence artificielle\ravenproject\sources\goals\goal_wander.h
...
; 22   : 	Goal_Wander(Raven_Bot* pBot) :Goal<Raven_Bot>(pBot, goal_wander)
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File d:\bac_informatique\intelligence artificielle\ravenproject\sources\goals\goal_getitem.cpp
_TEXT	SEGMENT
tv160 = -44						; size = 4
tv175 = -40						; size = 4
tv74 = -36						; size = 4
...
; 75   : 	//first, pass the message down the goal hierarchy
; 76   : 	bool bHandled = ForwardMessageToFrontMostSubgoal(msg);
...
; 77   : 
; 78   : 	//if the msg was not handled, test to see if this goal can handle it
; 79   : 	if (bHandled == false)
...
; 82   : 		{
; 83   : 		case Msg_PathReady:
; 84   : 
; 85   : 			//clear any existing goals
; 86   : 			RemoveAllSubgoals();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?RemoveAllSubgoals@?$Goal_Composite@VRaven_Bot@@@@QAEXXZ ; Goal_Composite<Raven_Bot>::RemoveAllSubgoals

; 87   : 
; 88   : 			AddSubgoal(new Goal_FollowPath(m_pOwner,
...
; 89   : 				m_pOwner->GetPathPlanner()->GetPath()));
; 90   : 
; 91   : 			//get the pointer to the item
; 92   : 			m_pGiverTrigger = static_cast<Raven_Map::TriggerType*>(msg.ExtraInfo);
...
; 64   : 	{
; 65   : 		//process the subgoals
; 66   : 		m_iStatus = ProcessSubgoals();
...
; 41   : 
; 42   : 	m_pGiverTrigger = 0;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+32], 0

; 43   : 
; 44   : 	//request a path to the item
; 45   : 	m_pOwner->GetPathPlanner()->RequestPathToItem(m_iItemToGet);
...
; 46   : 
; 47   : 	//the bot may have to wait a few update cycles before a path is calculated
; 48   : 	//so for appearances sake it just wanders
; 49   : 	AddSubgoal(new Goal_Wander(m_pOwner));
...
; 117  : 	if (m_pGiverTrigger &&
; 118  : 		!m_pGiverTrigger->isActive() &&
...
; 119  : 		m_pOwner->hasLOSto(m_pGiverTrigger->Pos()))
; 120  : 	{
; 121  : 		return true;
...
; 19   : 
; 20   : 	case type_shotgun:
; 21   : 
; 22   : 		return goal_get_shotgun;
...
; 23   : 
; 24   : 	case type_rail_gun:
; 25   : 
; 26   : 		return goal_get_railgun;
...
; 27   : 
; 28   : 	case type_rocket_launcher:
; 29   : 
; 30   : 		return goal_get_rocket_launcher;
